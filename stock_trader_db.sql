...
date_of_birth datetime, type_of_account varchar(30), last_login datetime,
...
transaction_type varchar(10) NOT NULL, date_of_transaction datetime NOT NULL,
num_of_shares int NOT NULL, total_cost float NOT NULL, order_status varchar(20) NOT NULL,
security_type varchar(20) NOT NULL, cost_of_share float NOT NULL,
primary key(order_num),
foreign key(stock_ID) references STOCK(stock_ID));

CREATE table if not exists BALANCE(user_ID int NOT NULL, net_account_value float,
net_cash float, purchase_power float, transaction_type varchar(10),
date_of_deposit datetime, deposit_amount float, date_of_withdrawal datetime,
